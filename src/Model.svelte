...
>
    ...
    <form method="dialog">
        ...
        <label for="content">
            <span>Content</span>
            <textarea name="content" id="content" cols="30" rows="10" bind:value={content}/>
        </label>
        ...
        <div class="btn">
            ...
            <button type="submit" on:click={() => addCard({title,content,tag,column_id:$selectedColumn})} autofocus>Submit</button>
        </div>
    </form>
</dialog>
